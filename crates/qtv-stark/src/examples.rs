...
//!
//! The squaring chain is a chain of modular multiplications over the field. The
//! single column holds a running value that squares from each row to the next.
//! It is a compact stand in for the modular arithmetic that the lattice
//! verification relation is built from.
...
/// value starts at the seed and squares along the chain. The first and last
/// values are pinned as public boundaries.
