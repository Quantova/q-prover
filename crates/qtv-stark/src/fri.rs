...
//! a verifier challenge, until the remaining polynomial is small enough to send
//! in the clear. Each fold halves the evaluation domain.
...
///
/// The lower half and the upper half are combined as low plus challenge times
/// high.
