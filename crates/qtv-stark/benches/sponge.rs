...
//!
//! It builds the sponge trace for a single block seed squeezed over several
//! permutations, proves it, and reports proving time, verification time, and
//! proof size. This is the cost of proving one hash stream, the unit the matrix
//! expansion and the challenge sampling of the batch verify relation repeat.
