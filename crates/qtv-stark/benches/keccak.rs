...
//!
//! It builds the arithmetized permutation trace over a sample state, proves it,
//! and reports proving time, verification time, and proof size. These are the
//! per permutation costs the hashing steps of the batch verify relation multiply.
