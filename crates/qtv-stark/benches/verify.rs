...
//!
//! For a batch of signatures it proves each arithmetized piece of the module
//! lattice verify relation, the transform domain modular multiplications, the
//! response infinity norm, the commitment decomposition, and the hint recovery,
//! and reports proving time, verification time, and proof size per piece and in
//! total.
