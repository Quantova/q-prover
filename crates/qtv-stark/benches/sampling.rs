...
//!
//! It proves one matrix rejection sampling pass, one challenge ball position
//! sampling pass, and one commitment high bit packing pass, and reports proving
//! time, verification time, and proof size for each. Together with the multi block
//! absorb measured in the sponge bench, these are the sampling steps that turn the
//! hash streams into the coefficients, the challenge, and the encoded bytes.
