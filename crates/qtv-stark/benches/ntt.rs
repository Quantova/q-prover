...
//!
//! It builds the transform trace at the ring degree, proves it, and reports
//! proving time, verification time, and proof size. The wiring between the eight
//! layers is carried by the permutation argument.
