//! Benchmark for the two hashing steps of the batch verify relation.
//!
//! It proves one matrix entry expansion stream and one challenge squeeze, and
//! reports proving time, verification time, and proof size for each, together
//! with the count of matrix entries the full expansion would repeat. The
//! rejection sampling and the multi block absorb that remain outside the trace
//! are documented in the hashing module.
