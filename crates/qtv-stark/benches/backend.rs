...
//!
//! It measures proving time and verification time at a representative domain
//! size. This data must exist before the consensus design is frozen, so the
//! numbers are produced here over the hash based FRI backend.
